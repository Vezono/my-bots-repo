...
works = [
    ...
    {'name': 'helpinkitchen',
     'locked': False,
     'lvl': 2,
     'desc': 'На кухне не хватает людей! Было бы хорошо, если бы ты помог{} им с приготовлением. Готов{}?'
     },
    ...
    {'name': 'washgenda',
     'locked': False,
     'lvl': 3,
     'desc': 'Наш памятник на главной площади совсем запылился. Не мог{} бы ты помыть его?'
     }
]
gender_replacer = {
    'М': ['', ''],
