...
def cave(id):
    ...
    ddd = 0
    mobs = ['Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда',
            'Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда',
            'Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда',
            'Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда', 'Червя-камнееда',
            'ОДИЧАВШИХ МЕНХЕРУ И ДВАЧТЯН']
    text = ''
